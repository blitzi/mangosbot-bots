...
bool PlayerbotAIConfig::Initialize()
{
    ...
    dispelAuraDuration = config.GetIntDefault("AiPlayerbot.DispelAuraDuration", 3000);
    reactDelay = (uint32) config.GetIntDefault("AiPlayerbot.ReactDelay", 0);
    ...
    stanceDistance = config.GetFloatDefault("AiPlayerbot.StanceDistance", 2.0f);
    ...
    LoadList<list<uint32> >(config.GetStringDefault("AiPlayerbot.damageFocusGUIDs", "17096,36619,38233,38459,38460,38711,38712,38970,38971,38972,38973,38974,38975"), damageFocusGUIDs);
