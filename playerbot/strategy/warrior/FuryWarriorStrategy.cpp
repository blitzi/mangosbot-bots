...
void FuryWarriorStrategy::InitTriggers(std::list<TriggerNode*> &triggers)
{
	...
	triggers.push_back(new TriggerNode(
		"victory rush",
		NextAction::array(0, new NextAction("victory rush", ACTION_EMERGENCY + 1), NULL)));

	triggers.push_back(new TriggerNode(
		"instant slam",
		NextAction::array(0, new NextAction("slam", ACTION_EMERGENCY), NULL)));

	triggers.push_back(new TriggerNode(
		"bloodthirst",
		NextAction::array(0, new NextAction("bloodthirst", ACTION_HIGH + 8), NULL)));

	triggers.push_back(new TriggerNode(
		"whirlwind",
		NextAction::array(0, new NextAction("whirlwind", ACTION_HIGH + 7), NULL)));
