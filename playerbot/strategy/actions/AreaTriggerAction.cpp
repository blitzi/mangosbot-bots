...
bool ReachAreaTriggerAction::Execute(Event event)
{
    ...
    if (bot->GetMapId() != atEntry->mapid || sqrt(bot->GetDistance(atEntry->x, atEntry->y, atEntry->z, DIST_CALC_NONE)) > sPlayerbotAIConfig.sightDistance)
    {
    ...
    float distance = sqrt(bot->GetDistance(atEntry->x, atEntry->y, atEntry->z, DIST_CALC_NONE));
