...
namespace ai
{
	...
	public:
        ...
        virtual bool Calculate() { return AI_VALUE(float, "durability") < 80; };
    };
    ...
    public:
        ...
        virtual bool Calculate() { return  ai->HasStrategy("rpg maintenance", BOT_STATE_NON_COMBAT) && AI_VALUE(float, "durability") < 100 && AI_VALUE(uint32, "repair cost") < AI_VALUE2(uint32, "free money for", (uint32)NeedMoneyFor::repair); };
    };
