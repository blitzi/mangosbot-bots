...
void GenericDruidStrategy::InitTriggers(std::list<TriggerNode*> &triggers)
{
    ...
    triggers.push_back(new TriggerNode(
        "critical health",
        NextAction::array(0, new NextAction("regrowth", ACTION_LOW_HEAL + 2), new NextAction("healing touch", ACTION_LOW_HEAL + 2), NULL)));

    triggers.push_back(new TriggerNode(
        "party member critical health",
        NextAction::array(0,  new NextAction("regrowth on party", ACTION_LOW_HEAL + 1), new NextAction("healing touch on party", ACTION_LOW_HEAL + 1), NULL)));
